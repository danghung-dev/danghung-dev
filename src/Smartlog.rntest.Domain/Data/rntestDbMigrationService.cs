...
{
    public class rntestDbMigrationService : ITransientDependency
    {
        public ILogger<rntestDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IrntestDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public rntestDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IrntestDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<rntestDbMigrationService>.Instance;
        }
